...
def rps():
    ...
    # Verify that the user is giving us a valid input
      # It's important to check isDigit first to take advantage of short
      #  circuit evalution and prevent type errors
    while numGames.isdigit() == False or int(numGames) not in range(1,10,2):
        print("You may play any odd number of games less than 10")
        numGames = input("Please enter the number of games you'd like to play: ")
        print("\n")
    ...
    while gamesPlayed < numGames:
        ...
        while playerChoice.isalpha() == False or playerChoice.lower() not in choices:
            print("Please enter Rock, Paper, or Scissors\n")
            playerChoice = input("What do you choose:  ")

        # Make the user's input lowercase for comparison
